...
* **block:** add derived block prover execution helper ([#164](https://github.com/taikoxyz/alethia-reth/issues/164)) ([be5b434](https://github.com/taikoxyz/alethia-reth/commit/be5b43415fb194d53b6be7db5382f026503a248e))
...
* **block:** update Uzen headers to set zero blob gas fields ([#146](https://github.com/taikoxyz/alethia-reth/issues/146)) ([89b457d](https://github.com/taikoxyz/alethia-reth/commit/89b457d3ba965a783483882fff6756f60ed45765))
...
* **chainspec:** add Taiko Masaya network support ([#112](https://github.com/taikoxyz/alethia-reth/issues/112)) ([e94302c](https://github.com/taikoxyz/alethia-reth/commit/e94302ce89f73c845f27194b20f2e9faedf7b9c6))
* **chainspec:** add Uzen fork (timestamp-based), map to `OSAKA`, and no blob transaction ([#115](https://github.com/taikoxyz/alethia-reth/issues/115)) ([dd2d4b5](https://github.com/taikoxyz/alethia-reth/commit/dd2d4b5974d43f652f785e4b69b1e56417c3f853))
...
* **chainspec:** differentiate block limit by network — Masaya 1B, others 100M ([#170](https://github.com/taikoxyz/alethia-reth/issues/170)) ([7e8ee81](https://github.com/taikoxyz/alethia-reth/commit/7e8ee81300ef5809e083941a3b00cdf482aaab4a))
...
* **chainspec:** update mainnet Shasta timestamp ([#127](https://github.com/taikoxyz/alethia-reth/issues/127)) ([6615755](https://github.com/taikoxyz/alethia-reth/commit/6615755c1c2e62e32b5c0428863ec950783f101e))
...
* **cli:** rename devnet Uzen override ([#151](https://github.com/taikoxyz/alethia-reth/issues/151)) ([d337d5c](https://github.com/taikoxyz/alethia-reth/commit/d337d5c6f34e3001415a56c972386f1509d3ee05))
...
* **consensus:** parameterize EIP-4396 min base fee clamp and set Mainnet floor to `0.01` Gwei ([#113](https://github.com/taikoxyz/alethia-reth/issues/113)) ([e0dec6f](https://github.com/taikoxyz/alethia-reth/commit/e0dec6fe87490d2b0ca6d5bd8858e12c2a17b29a))
...
* **evm:** introduce ZKGas in Uzen fork ([#134](https://github.com/taikoxyz/alethia-reth/issues/134)) ([dfbe4c7](https://github.com/taikoxyz/alethia-reth/commit/dfbe4c7769c8115f06a5e9f96c910f07f9dbb57b))
...
* **evm:** record anchor witness accounts for `raiko2` ([#161](https://github.com/taikoxyz/alethia-reth/issues/161)) ([68d921e](https://github.com/taikoxyz/alethia-reth/commit/68d921ee176eb3834bd531764c2b09fbf0ed2730))
...
* **rpc:** add proof-history witness and proof path ([#167](https://github.com/taikoxyz/alethia-reth/issues/167)) ([a78d361](https://github.com/taikoxyz/alethia-reth/commit/a78d361ee8c0aa2b31fc35cff6304f98d9db0e2c))
* **rpc:** align `RpcL1Origin` signature serde ([#132](https://github.com/taikoxyz/alethia-reth/issues/132)) ([fe78eb3](https://github.com/taikoxyz/alethia-reth/commit/fe78eb3bda2f73f4713ee7868024ade9b6f2a717))
* **rpc:** align `taikoAuth` batch lookup behavior with `taiko-geth` ([#114](https://github.com/taikoxyz/alethia-reth/issues/114)) ([14b6eef](https://github.com/taikoxyz/alethia-reth/commit/14b6eeffcebe7be68d0603665872c32c3b0e2ffc))
...
* **rpc:** introduce auth api `taikoAuth_lastCertainBlockIDByBatchID` ([#135](https://github.com/taikoxyz/alethia-reth/issues/135)) ([d25fa88](https://github.com/taikoxyz/alethia-reth/commit/d25fa8823b766f0f66c0ee272a0460cfa0e3afec))
* **rpc:** make `signature_hex_serde` public ([#133](https://github.com/taikoxyz/alethia-reth/issues/133)) ([432362e](https://github.com/taikoxyz/alethia-reth/commit/432362e14ee69d6b1affb5ba3108cd62e2b2e7dd))
* **rpc:** move batch lookup RPCs to `taikoAuth` and align with `taiko-geth` ([#103](https://github.com/taikoxyz/alethia-reth/issues/103)) ([41fac9f](https://github.com/taikoxyz/alethia-reth/commit/41fac9fd014a9944439aa2c2fbae56f9f1a627f3))
* **rpc:** persist Shasta batch-to-last-block on forkchoice update ([#149](https://github.com/taikoxyz/alethia-reth/issues/149)) ([8c8ecf1](https://github.com/taikoxyz/alethia-reth/commit/8c8ecf1799ffcab88670aa6ad5271d341d089f93))
...
* **rpc:** return U256 from `setBatchToLastBlock` for taiko-geth parity ([#147](https://github.com/taikoxyz/alethia-reth/issues/147)) ([da3b9b8](https://github.com/taikoxyz/alethia-reth/commit/da3b9b8bc7e53e719a44ddd2ae87ad5d1fb0b791))
...
* **rpc:** update Uzen `getPayloadV2` to round-trip `header.difficulty` through `blockValue` ([#145](https://github.com/taikoxyz/alethia-reth/issues/145)) ([38c89c9](https://github.com/taikoxyz/alethia-reth/commit/38c89c9bb979ae915a940cedb0d5f76f2bb82612))
...
* **taiko:** introduce auth api `taikoAuth_lastCertainL1OriginByBatchID` ([#136](https://github.com/taikoxyz/alethia-reth/issues/136)) ([1a60419](https://github.com/taikoxyz/alethia-reth/commit/1a60419a419d3cb38a8e68581391b2615f0fa0c3))
...
* **block:** fix devnet Uzen timestamp override for shared Ethereum forks ([#153](https://github.com/taikoxyz/alethia-reth/issues/153)) ([bc92efc](https://github.com/taikoxyz/alethia-reth/commit/bc92efc10b1c79d3eedf878701a0fcc5bd22130f))
* **chainspec:** expose uzen blob params ([dedacae](https://github.com/taikoxyz/alethia-reth/commit/dedacaeeb3ed58661da37f135d150ad194c4a2e1))
* **chainspec:** expose Uzen blob params ([#152](https://github.com/taikoxyz/alethia-reth/issues/152)) ([dedacae](https://github.com/taikoxyz/alethia-reth/commit/dedacaeeb3ed58661da37f135d150ad194c4a2e1))
...
* **chainspec:** regenerate genesis header on devnet Uzen override ([#154](https://github.com/taikoxyz/alethia-reth/issues/154)) ([426875d](https://github.com/taikoxyz/alethia-reth/commit/426875d6817c3c8b92bd1e87ea70b78eb2220310))
...
* **docker:** align Docker build/runtime base images ([#131](https://github.com/taikoxyz/alethia-reth/issues/131)) ([637f7a1](https://github.com/taikoxyz/alethia-reth/commit/637f7a150f72fe8d6cc5949a41aebb638a5305cf))
...
* rename fork to unzen ([2601082](https://github.com/taikoxyz/alethia-reth/commit/26010828d12e5b6a7f9cb7588278adef4268167c))
* **repo:** align Docker build/runtime base images and ignore worktrees ([637f7a1](https://github.com/taikoxyz/alethia-reth/commit/637f7a150f72fe8d6cc5949a41aebb638a5305cf))
...
* **rpc,block:** avoid basefee unwrap; factor error mapping ([#105](https://github.com/taikoxyz/alethia-reth/issues/105)) ([0e2bde4](https://github.com/taikoxyz/alethia-reth/commit/0e2bde448433e23644d76a3b9a4fedcdefcd4e62))
* **rpc:** align taikoAuth batch lookup behavior with taiko-geth ([14b6eef](https://github.com/taikoxyz/alethia-reth/commit/14b6eeffcebe7be68d0603665872c32c3b0e2ffc))
...
* **rpc:** restore backward compatibility for `taikoAuth_txPoolContent` params (regression from eb30aeb) ([#119](https://github.com/taikoxyz/alethia-reth/issues/119)) ([5029777](https://github.com/taikoxyz/alethia-reth/commit/502977785555bd70d7282ee07a3621fa269f6fc3))
...
* **alethia-reth:** enforce docs/clippy standards and refactor taikoAuth tx-pool params ([eb30aeb](https://github.com/taikoxyz/alethia-reth/commit/eb30aeb0754270a3aa4e0b0bb8f42542bd082f3a))
...
* **block:** add Uzen parent beacon block root normalization ([#142](https://github.com/taikoxyz/alethia-reth/issues/142)) ([a61761e](https://github.com/taikoxyz/alethia-reth/commit/a61761ee9a8c172a222c6892325c6521a3abbfa5))
...
* **block:** update Uzen requests hash reconstruction ([#144](https://github.com/taikoxyz/alethia-reth/issues/144)) ([c564833](https://github.com/taikoxyz/alethia-reth/commit/c564833c8af5330ec6e88df115fe156a80daeb7c))
...
* **chainspec:** set Masaya Unzen fork time to `2026-05-07 13:00 UTC` ([#169](https://github.com/taikoxyz/alethia-reth/issues/169)) ([d1e8318](https://github.com/taikoxyz/alethia-reth/commit/d1e831837fddfe6dbf8f7e43a77488316f1458bc))
* **chainspec:** update `TAIKO_HOODI_HARDFORKS` ([#107](https://github.com/taikoxyz/alethia-reth/issues/107)) ([a8f6232](https://github.com/taikoxyz/alethia-reth/commit/a8f62328350db14ef29b3f11cb5d94ae41cdf56a))
* **chainspec:** update devnet genesis and strip contractName ([#150](https://github.com/taikoxyz/alethia-reth/issues/150)) ([d85bc17](https://github.com/taikoxyz/alethia-reth/commit/d85bc17585a14c373fddf17e0cdd949b0eef884e))
...
* **chainspec:** update Hoodi Shasta timestamp ([#108](https://github.com/taikoxyz/alethia-reth/issues/108)) ([55b1207](https://github.com/taikoxyz/alethia-reth/commit/55b1207ec4d2cd4d9918b6456d68f8014174cf24))
...
* **consensus:** rename fork to Unzen ([#168](https://github.com/taikoxyz/alethia-reth/issues/168)) ([2601082](https://github.com/taikoxyz/alethia-reth/commit/26010828d12e5b6a7f9cb7588278adef4268167c))
...
* **deps:** bump `reth` to `v2.1.0` ([#158](https://github.com/taikoxyz/alethia-reth/issues/158)) ([aba0499](https://github.com/taikoxyz/alethia-reth/commit/aba0499ca74ac2a3e40cff34ca8d55bdef9916c1))
* **deps:** bump reth to v1.11.1 ([be4afca](https://github.com/taikoxyz/alethia-reth/commit/be4afca64b2f668571bfeae3a9fffc35f016fbcb))
* **deps:** bump reth to v1.11.3 and align Rust toolchains ([9705d85](https://github.com/taikoxyz/alethia-reth/commit/9705d857c8ae365e6abb6273b843aab88d98ef87))
* **deps:** upgrade reth to v1.11.0 and align related dependencies ([15edc4b](https://github.com/taikoxyz/alethia-reth/commit/15edc4b6c13bc7a9cbf0e026fa329bf30f535139))
...
* **main:** release 0.5.0 ([#40](https://github.com/taikoxyz/alethia-reth/issues/40)) ([3bcdad1](https://github.com/taikoxyz/alethia-reth/commit/3bcdad118072d0c5e50950449dbbc54187332b29))
* **main:** release 0.6.0 ([#47](https://github.com/taikoxyz/alethia-reth/issues/47)) ([80943c0](https://github.com/taikoxyz/alethia-reth/commit/80943c07c3fe8d3e2102f8132ba778ae54f6ac86))
* **main:** release 0.7.0 ([#66](https://github.com/taikoxyz/alethia-reth/issues/66)) ([f38396e](https://github.com/taikoxyz/alethia-reth/commit/f38396ed23493cfb9e7c6e8cf08904fd0cc4858a))
* **main:** release 0.7.1 ([#139](https://github.com/taikoxyz/alethia-reth/issues/139)) ([2415860](https://github.com/taikoxyz/alethia-reth/commit/2415860654d031d6ef70767b59c0d931a3beff44))
* **payload:** change payload version to `PAYLOAD_ID_VERSION_V2` ([#163](https://github.com/taikoxyz/alethia-reth/issues/163)) ([122f19b](https://github.com/taikoxyz/alethia-reth/commit/122f19b3fe5be6b90397cc580bda4e7f06b2f1fd))
...
* **repo:** bump `reth` to `v1.11.1` ([#121](https://github.com/taikoxyz/alethia-reth/issues/121)) ([be4afca](https://github.com/taikoxyz/alethia-reth/commit/be4afca64b2f668571bfeae3a9fffc35f016fbcb))
* **repo:** bump `reth` to `v1.11.2` ([#128](https://github.com/taikoxyz/alethia-reth/issues/128)) ([6909c3a](https://github.com/taikoxyz/alethia-reth/commit/6909c3ae3b8a1a1937190cee0f5e56ce9cb5b560))
...
* **repo:** bump reth to `v1.11.3` and align Rust toolchains ([#130](https://github.com/taikoxyz/alethia-reth/issues/130)) ([9705d85](https://github.com/taikoxyz/alethia-reth/commit/9705d857c8ae365e6abb6273b843aab88d98ef87))
* **repo:** enforce docs/clippy standards and update `AGENTS.md` ([#118](https://github.com/taikoxyz/alethia-reth/issues/118)) ([eb30aeb](https://github.com/taikoxyz/alethia-reth/commit/eb30aeb0754270a3aa4e0b0bb8f42542bd082f3a))
...
* **repo:** upgrade `reth` to `v1.11.0` and align related dependencies ([#116](https://github.com/taikoxyz/alethia-reth/issues/116)) ([15edc4b](https://github.com/taikoxyz/alethia-reth/commit/15edc4b6c13bc7a9cbf0e026fa329bf30f535139))
...
* **rpc:** normalize Uzen parent beacon block root in engine validator ([#143](https://github.com/taikoxyz/alethia-reth/issues/143)) ([b3f4ee9](https://github.com/taikoxyz/alethia-reth/commit/b3f4ee9f56d9ee9638b1de4b688bd57907ea7818))
...
* **cli:** use `wait_for_node_exit()` in alethia-reth main ([3edd4d0](https://github.com/taikoxyz/alethia-reth/commit/3edd4d08b5b05e261939ed63f980e0a6a4d05666))
...
* **main:** use `wait_for_node_exit()` ([#117](https://github.com/taikoxyz/alethia-reth/issues/117)) ([3edd4d0](https://github.com/taikoxyz/alethia-reth/commit/3edd4d08b5b05e261939ed63f980e0a6a4d05666))
...
* **repo:** extract `rpc-types` crate, `primitives::taiko` module, and `anchor_constants` behind feature gate ([#129](https://github.com/taikoxyz/alethia-reth/issues/129)) ([03fc092](https://github.com/taikoxyz/alethia-reth/commit/03fc0929b324aff68ee5bc26f1c0a8169b58060b))
* **repo:** improve agent-native readiness with Rust checks and add baseline tests ([#123](https://github.com/taikoxyz/alethia-reth/issues/123)) ([418fe54](https://github.com/taikoxyz/alethia-reth/commit/418fe5400167420cb245f2bf5c26273b4b8e7e86))
...
* **repo:** modularize core modules and harden CI/agent workflows ([ead6ae0](https://github.com/taikoxyz/alethia-reth/commit/ead6ae0b71fd1186a838e42c36b7e9cc81582e19))
...
* **repo:** split `auth`/`validation`/`tx-selection`/`builder` into focused modules ([#124](https://github.com/taikoxyz/alethia-reth/issues/124)) ([ead6ae0](https://github.com/taikoxyz/alethia-reth/commit/ead6ae0b71fd1186a838e42c36b7e9cc81582e19))
* **reth:** clean up tx selection and auth rpc tests ([#125](https://github.com/taikoxyz/alethia-reth/issues/125)) ([a575e62](https://github.com/taikoxyz/alethia-reth/commit/a575e625374de3403df8517069626d007102cfc8))
* **rpc:** consolidate L1 origin conversion into single helper ([#159](https://github.com/taikoxyz/alethia-reth/issues/159)) ([08af1a0](https://github.com/taikoxyz/alethia-reth/commit/08af1a077cfb98f8e6df95fec2f130901c8698b1))
...
* **repo:** reduce allocations and remove base-fee unwraps across `consensus`/`block`/`primitives` ([#106](https://github.com/taikoxyz/alethia-reth/issues/106)) ([c7fc51d](https://github.com/taikoxyz/alethia-reth/commit/c7fc51d67b289cf2895fb0214d23583ccc1cccbe))
* **rpc,payload,block,db:** reduce cloning and preallocate lists ([#104](https://github.com/taikoxyz/alethia-reth/issues/104)) ([f765312](https://github.com/taikoxyz/alethia-reth/commit/f765312a8ad05a9b609630fd7f25f36710b50fc7))
* **rpc:** align batch last-block scan optimization and head uncertainty logic  ([#109](https://github.com/taikoxyz/alethia-reth/issues/109)) ([d5a6b6a](https://github.com/taikoxyz/alethia-reth/commit/d5a6b6aca5b38ddcab4f134285b13c23095869d1))
