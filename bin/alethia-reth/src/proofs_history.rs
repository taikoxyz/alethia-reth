...
//! MDBX-backed proof storage, installs the [`ProofsExEx`] execution
...
use alethia_reth_proofs_trie::{MdbxProofsStorage, ProofsStorage};
...
/// Otherwise, the MDBX sidecar store is opened, the [`ProofsExEx`] is
    ...
    jsonrpsee_types::error::ErrorObject<'static>: From<<AO::EthApi as EthApiTypes>::Error>,
{
    ...
    let storage: ProofsStorage<Arc<MdbxProofsStorage>> = mdbx.into();
