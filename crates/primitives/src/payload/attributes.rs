...
impl PayloadAttributes for TaikoPayloadAttributes {
    ...
    /// Delegates to the wrapped ETH attributes' slot number.
    fn slot_number(&self) -> Option<u64> {
        self.payload_attributes.slot_number()
    }

    /// Delegates to the wrapped ETH attributes' requested target gas limit.
    fn target_gas_limit(&self) -> Option<u64> {
        self.payload_attributes.target_gas_limit()
    }
}
