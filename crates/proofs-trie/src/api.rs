...
#[auto_impl(Arc)]
pub trait ProofsProviderRO: Send + Sync + Debug {
...
pub trait ProofsProviderRw: ProofsProviderRO {
...
pub trait ProofsInitProvider: Send + Sync + Debug {
    ...
    /// capture, use [`store_trie_updates`](ProofsProviderRw::store_trie_updates).
