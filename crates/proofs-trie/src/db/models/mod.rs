//! MDBX implementation of the proofs sidecar store.
//!
//! This module provides a complete MDBX implementation for the proofs-trie crate.
//! It uses the [`reth_db`] crate for database interactions and defines the necessary
//! tables and models for storing trie branches, accounts, and storage leaves.
