//! Error and output types for the proofs storage pruner.

use crate::{ProofsStorageError, api::WriteCounts};
...
/// Result of [`ProofsStoragePruner::run`](crate::ProofsStoragePruner::run) execution.
pub type ProofsStoragePrunerResult = Result<PrunerOutput, PrunerError>;
...
pub enum PrunerError {
    /// Wrapped error from the underlying `ProofsStore` layer.
    Storage(#[from] ProofsStorageError),
