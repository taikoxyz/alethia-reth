//! Metrics for the proofs storage pruner.
...
/// Pruner metrics collected under the `alethia_proofs_storage.pruner` scope.
#[derive(Metrics)]
#[metrics(scope = "alethia_proofs_storage.pruner")]
...
impl Metrics {
    /// Record the outcome of a single prune batch.
